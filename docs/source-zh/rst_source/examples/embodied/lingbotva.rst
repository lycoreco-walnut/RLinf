...
* ``evaluations/robotwin/robotwin_click_bell_lingbotva_eval.yaml``
* ``evaluations/robotwin/robotwin_place_empty_cup_lingbotva_eval.yaml``
...
.. code-block:: bash
   ...
   bash evaluations/run_eval.sh robotwin_click_bell_lingbotva_eval
